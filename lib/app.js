...
program.version(pkg.version).option('-p, --port <port>', 'REST service port', 3000).option('-b, --mongo <string>', 'MongoDB connection string', 'mongo://localhost/default').option('-m, --memcached <string>', 'Memcached servers list', '127.0.0.1:11211').option('-v, --verbose', 'Log requests', false).option('--memcached-prefix <string>', 'Memcached keys prefix', 's_').parse(process.argv);
